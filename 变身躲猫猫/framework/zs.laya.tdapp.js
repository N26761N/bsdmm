...
(function (exports, Laya) {
    ...
    class tdAppSdk {
        ...
        static event(eventData) {
            ...
            if (this.instance) {
                ...
                if (eventData.id == this.event_level_complete_label) {
    ...
    tdAppSdk.event_game_over_label = "关卡";    
    ...
    class customEvt extends tdAppEvent {
        constructor(id,desc) {
            super();
            this.id = desc;
            this.label = id;
    ...
    Laya.ClassUtils.regClass("zs.laya.tdapp.customEvt", customEvt);

    class startupEvt extends tdAppEvent {
        constructor() {
            super();
            this.id = tdAppSdk.event_startup_label;
            this.label = tdAppSdk.event_startup_id;
            this.params = {timestamp: Date.now()};
        }
    }
    ...
    class loginEvt extends tdAppEvent {
        constructor(userId) {
            super();
            this.id = tdAppSdk.event_login_label;
            this.label = tdAppSdk.event_login_id;
    ...
    class gameStartEvt extends tdAppEvent {
        constructor(userId) {
            super();
            this.id = tdAppSdk.event_game_start_label;
            this.label = tdAppSdk.event_game_start_id;
    ...
    class gameOverEvt extends tdAppEvent {
        constructor(userId, result,levelId) {
            super();
            this.id = tdAppSdk.event_game_over_label +"_" + levelId + "_" + result ;
            this.label = tdAppSdk.event_game_over_id;
            this.params = {timestamp: Date.now(), userId: userId,  result: result};//gameId: gameId,
        }
    }
    ...
    class levelCompletedEvt extends tdAppEvent {
        constructor(userId, levelId) {
            super();
            this.id = tdAppSdk.event_level_complete_label;
            this.label = tdAppSdk.event_level_complete_id;
    ...
    class levelCompletedExEvt extends tdAppEvent {
        constructor(userId, levelId) {
            super();
            this.id = tdAppSdk.event_level_complete_label + "_" + levelId;
            this.label = tdAppSdk.event_level_complete_id + "_" + levelId;
            this.params = {timestamp: Date.now(), userId: userId, levelId: levelId};
        }
    }
