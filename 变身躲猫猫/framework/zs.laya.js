...
(function (exports, Laya) {
    ...
    class MiscUtils {
        ...
        static hex_md5(s) { s = this.utf8Encode(s); return this.binl2hex(this.core_md5(this.str2binl(s), s.length * this.chrsz)); }
    ...
    class XHRUtils {
        ...
        static xhrPost(api, args) {
            if (zs.laya.sdk.DeviceService.IsNetValid() == false) {
    ...
    class SoundService extends Laya.Script {
        ...
        onAwake() {
            Laya.stage.on(zs.laya.sdk.DeviceService.EVENT_ON_SHOW, this, this.onAppShow);
            Laya.stage.on(zs.laya.sdk.DeviceService.EVENT_ON_HIDE, this, this.onAppHide);
        }

        onDestroy() {
            Laya.stage.off(zs.laya.sdk.DeviceService.EVENT_ON_SHOW, this, this.onAppShow);
            Laya.stage.off(zs.laya.sdk.DeviceService.EVENT_ON_HIDE, this, this.onAppHide);
        }
